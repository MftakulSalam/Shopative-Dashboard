...
export default function LoginPage() {
  return (
    <div className="min-h-screen bg-[url(/login-bg.jpg)] flex">
      <div
        className="relative p-8 items-center flex flex-col rounded-3xl mx-auto my-auto w-fit bg-gradient-to-b from-cyan-200 to-white via-white to-80% "
        style={{ boxShadow: "0 0 8px #fff" }}
      >
        <Link
          href={"/"}
          className="absolute top-4 right-4 text-gray-500 dark:text-red-500 text-xl"
        >
          <IoClose />
        </Link>
        ...
        <form className="w-full mx-auto mt-7 flex flex-col gap-4">
          ...
          <p className="font-poppins text-[0.8rem] font-light text-zinc-400 text-center">
            Belum punya akun?{" "}
            <span className="font-semibold text-black">Buat akun</span> di sini.
          </p>
